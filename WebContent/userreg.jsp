...
<body background="images/enc1.jpg">
	...
	<center><h1 class="pageTitle"><b>User Registration</b></h1></center>
			...
			<table class="login_style">
				<tr>
					<td><table>
							...
							<tr>
								<td>Password</td>
								<td><input type="password" name="passwd" size="20" pattern=".{6,}" title="Minimum 6 characters"
									required="required"> <span id=password1></span></td>
							</tr>
							<tr>
								<td>ConfirmPassword</td>
								<td><input type="password" name="CONFIRM" size="20" pattern=".{6,}" title="Minimum 6 characters"
