		...
		<table class="display_table">
			<%
				...
				try {
					...
					String query = "select id,filename,filekey,hashkey,server from filedetails where filename = '" + fileName
							+ "' and auth in (1)";
			...
			<tr style="font-size: large; color: slateblue; font-family: serif">
				...
				<td style="text-align: left"><a
					href="sendEmail.jsp?id=<%=uid%>&filekey=<%=resultset1.getString(3)%>&attribute=<%=resultset1.getString(4)%>">Request Keys</a></td>
			</tr>
			<%
				}
					}
