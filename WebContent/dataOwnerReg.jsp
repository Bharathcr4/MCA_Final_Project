...
<body background="images/enc1.jpg">
	...
	<center><h1 class="pageTitle"><b>Data Owner Registration</b></h1></center>
			...
			<table class="login_style">
				<tr>
					<td><table>
							...
							<tr>
								<td>Phone</td>
								<td><input type="number" name="phone" pattern="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$" title="Invalid Phone No(10 Digits)" size="20"><br>
									<span id=phone1></span></td>
							</tr>
							<tr>
								<td>Password</td>
								<td><input type="password" name="passwd" pattern=".{5,}" title="Minimum 5 characters" size="20">
									<span id=password1></span></td>
							</tr>
							<tr>
								<td>ConfirmPassword</td>
								<td><input type="password" name="CONFIRM" size="20" pattern=".{5,}" title="Minimum 5 characters">
