...
public class AESUtility2 {
	...
	public static void main(String[] args) {
		...
		String encryptedString = AESUtility2.encrypt(originalString, secretKey);
		String decryptedString = AESUtility2.decrypt(encryptedString, secretKey);
